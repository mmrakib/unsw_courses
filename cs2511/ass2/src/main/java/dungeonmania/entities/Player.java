...
public class Player extends Entity implements Battleable, Moveable {
    ...
    private int spawnersKilledCount = 0;
    ...
    public void setSpawnersKilled(int spawnersKilledCount) {
        this.spawnersKilledCount = spawnersKilledCount;
    }
}
