...
public class BasicGoalsTest {
    ...
    @Test
    @Tag("13-5")
    @DisplayName("Test achieving an enemy goal with 3 enemies and 1 spawner")
    public void enemyBasic() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_basicGoalsTest_enemyBasic", "c_basicGoalsTest_enemyBasic");
        ...
        // assert picked up sword
        assertEquals(1, TestUtils.getInventory(res, "sword").size());

        // move player to right and assert goal not met
        res = dmc.tick(Direction.RIGHT);
        assertTrue(TestUtils.getGoals(res).contains(":enemies"));
    ...
    @Test
    @Tag("13-6")
    @DisplayName("Test achieving an enemy goal with no enemies and 1 spawner")
    public void enemyNoEnemies() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_basicGoalsTest_enemyNoEnemies", "c_basicGoalsTest_enemyNoEnemies");
    ...
    @Test
    @Tag("13-7")
    @DisplayName("Test achieving an enemy goal with no spawners and 1 enemy")
    public void enemyNoSpawners() {
        DungeonManiaController dmc;
        dmc = new DungeonManiaController();
        DungeonResponse res = dmc.newGame("d_basicGoalsTest_enemyNoSpawners", "c_basicGoalsTest_enemyNoSpawners");
