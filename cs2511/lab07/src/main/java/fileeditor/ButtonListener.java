...
public class ButtonListener implements ActionListener {
    ...
    private int newWindowX;
    private int newWindowY;
     ...
     *
     * @param pane The JDesktopPane to which this ButtonListener is attached.
     *
     */
    ...
    /**
     * Performs the appropriate action depending on the type of event triggered.
     *
     * @param event The ActionEvent corresponding to the button clicked
     *
     */
    ...
    private void openUrl(String url) {
        ...
        this.addDocument(document);
        docCount++;
        document.getJTextArea().append(page.getHost());
        try {
            document.getJTextArea().read(new InputStreamReader(conn.getInputStream()), null);
        } catch (IOException e) {
        }
    }
     ...
     *
     * @param document The Document to be added to the desktop pane
     */
     ...
     *
     * @return The TextDocument object of the currently selected document.
     */
