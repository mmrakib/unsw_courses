...
public abstract class Document extends JInternalFrame {
    /**
     * Creates a new Document object with the given title and coordinates
     *
     * @param title The String title of the new Document object
     * @param x     The horizontal position on screen of the new Document
     * @param y     The vertical position on screen of the new Document
     *
     */
    ...
    /**
     * Opens a dialog box to select an file to be opened and reads the selected file
     * into the current Document.
     *
     * @return A boolean value indicating whether a file has been opened or not
     */
    public boolean open() {
    ...
    /**
     * Saves the contents of the text area to a text file with the text area title
     * as filename
     */
    public void save() {
        try {
     ...
     *
     * @return A boolean indicating whether the current Document object has been
     *         saved to file.
     */
    ...
    /**
     * Copies the contents of the clipboard into the text area of this Document.
     */
    public void paste() {
        this.textArea.paste();
        textArea.grabFocus();
     ...
     *
     * @param text The String which is to be appended to the text area on a line of
     *             its own.
     */
